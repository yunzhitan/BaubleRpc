...
public class DateUtils {
     ...
     */
    public static Date strToDate(String dateStr) throws java.text.ParseException {
     ...
     * @throws java.text.ParseException 解析异常
     */
    public static Date strToDate(String dateStr, String format) throws java.text.ParseException {
